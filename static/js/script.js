...
const tableBodySection = document.querySelector(".table__body");
...
csv_btn.onclick = () => {
  ...
  downloadFile(csv, "csv", "job applications");
};
...
excel_btn.onclick = () => {
  ...
  console.log("The excel file is ", excel);
  downloadFile(excel, "excel", "Job Application");
};
